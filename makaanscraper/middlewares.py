...
class MakaanscraperSpiderMiddleware:
...
class MakaanscraperDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
class ScarpeOpsFakeUserAgentMiddleware:
    ...
    def _scrapeops_fake_user_agents_enabled(self):
        if self.scrapeops_api_key is None or self.scrapeops_api_key == ' 'or self.scrapeops_fake_headers_active == False:
            self._scrapeops_fake_user_agents_enabled = False
        else:
            self._scrapeops_fake_user_agents_enabled = True
